# -*- coding: utf-8 -*-
"""3Channel CognitiveRadioEnvironment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1IF65mpTfnxqbegfVeYXLkfvFsgSq1cjb
"""
...
class Radio():
	def __init__(self, channel = 3, max_env_steps = 100):
		"""
		Parameters
		----------
		action :
...
def deep_q_learning(alpha,gamma,epsilon,edisodes,max_steps,n_tests,render=False,test=False):
    ...
    var_init_bias = Variable(torch.tensor([0.0,0.0,0.0],device='cpu').type(torch.DoubleTensor),requires_grad=True)
...
plotTrainingResultReward(_iter_index = iter_index[:], _iter_reward = iter_reward[:], _iter_total_steps = iter_total_steps[:], _fileTitle = '3_channel_Quantum_cognitiveRaio_Dynamic_Epsilon_RMSProp')
