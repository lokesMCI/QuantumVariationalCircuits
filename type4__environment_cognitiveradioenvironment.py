# -*- coding: utf-8 -*-
"""Type4_ environment_CognitiveRadioEnvironment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ZeHHLR88BHCF74uvKcFNTuPQjv3OE481
"""
...
df = pd.read_csv("/content/VQC (3).csv")

df.head()

iter_index = list(df['Episode'])

iter_reward = list(df['Rewards'])

print(len(iter_index))

i=0
while(len(iter_reward)<500):
  iter_index.append(iter_index[-1]+1)
  iter_reward.append(100)

for i in range(iter_index[-1],500):
  iter_index.append(i)
  iter_reward.append(98)
