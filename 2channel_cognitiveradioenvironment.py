# -*- coding: utf-8 -*-
"""2Channel CognitiveRadioEnvironment.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Lq4O_371hTl2s_Z-96IR9H7FJ8kwbXnt
"""
...
class Radio():
	def __init__(self, channel = 2, max_env_steps = 100):
		"""
		Parameters
		----------
		action :
...
def deep_q_learning(alpha,gamma,epsilon,edisodes,max_steps,n_tests,render=False,test=False):
    ...
    var_init_bias = Variable(torch.tensor([0.0,0.0],device='cpu').type(torch.DoubleTensor),requires_grad=True)
    ...
    print(drawer(var_q_circuit,[0,0]))
...
file_title = '2_channel_VQDQN_CognitiveRadio_Epsilon_RMSProp' + datetime.now().strftime("NO%Y%m%d%H%M%S")

plotTrainingResultReward(_iter_index = iter_index[:], _iter_reward = iter_reward[:], _iter_total_steps = iter_total_steps[:], _fileTitle = '2_channel_Quantum_cognitiveRaio_Dynamic_Epsilon_RMSProp')
